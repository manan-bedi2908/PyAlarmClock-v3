...
import json
import sys
sys.path.append("E:/Minor Project/PyAlarmClock-main/src/backend")
#from src.backend.AlarmClock.Alarm import*
from src.backend.AlarmClock.OpenEyesAlarm import *
from src.backend.AlarmClock.SpeechAlarm import *
